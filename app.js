...
function getNewQuestion(){
    ...
    // remove the 'questionIndex' from the availbleQuestion Array, so that the question does not repeat
...
// make all the options unclickable once the user selects a option (RESTRICT THE USER TO CHANFE THE OPTION AGAIN)
